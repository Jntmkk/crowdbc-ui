  ...
  <div class="app-container">
    <el-card style="margin: 50px 100px">
      <div slot="header" class="clearfix">
        <h2 style="margin-left: 30px">设置</h2>
      </div>
      <el-form ref="ruleForm" :model="form" label-width="80px">
        <el-card style="margin: 20px 20px">
          <div slot="header" class="clearfix">
            <span>用户设置</span>
            <el-button type="info" round size="mini" style="margin-left: 10px" @click="editAndApply">
              {{ userSetting.editAndApplyText }}
            </el-button>
          </div>
      ...
      <el-card style="margin: 20px 20px">
        ...
        <el-table v-loading="table.loading" :data="table.listAccount"
          ...
          <el-table-column align="center" label="操作" width="150">
            <template v-slot="scope">
              <el-button type="danger" round @click="deleteAccount(scope.row)">删除</el-button>
            </template>
          </el-table-column>
        </el-table>
        <el-row type="flex" style="flex-direction: row-reverse;justify-content: space-between;margin: 10px 0px">
          <el-col :span="4">
            <el-button style="margin-left: 160px;margin-top: 20px" @click="addAccount">添加账户</el-button>
          </el-col>
        </el-row>
      </el-card>
    </el-card>
